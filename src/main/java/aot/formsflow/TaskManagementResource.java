...
public class TaskManagementResource {
    ...
    @Path("{processId}/instances/{processInstanceId}/tasks")
    public TaskIds getTasks(@PathParam("processId") String processId,
            @PathParam("processInstanceId") String processInstanceId,
            @QueryParam("user") final String user, @QueryParam("group") final List<String> groups) {
        TaskIds taskIds = this.appRoot.get(ProcessIds.class).get(processId).instances().get(processInstanceId).tasks();
        return taskIds;
    }
    ...
    public Response updateTask(@PathParam("processId") String processId,
            @PathParam("processInstanceId") String processInstanceId, @PathParam("taskId") String taskId,
            @QueryParam("user") final String user, @QueryParam("group") final List<String> groups, TaskInfo taskInfo) {
